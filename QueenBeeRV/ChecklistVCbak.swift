...
class ChecklistVCbak: UIViewController {
...
//        tableView.rowHeight = 100
    ...
    func getChecklist() {
        ...
        var completedValue = false
            ...
            if let checklistFileURL = Bundle.main.url(forResource: "checklist_set_up", withExtension: "json") {
...
extension ChecklistVCbak: UITableViewDelegate, UITableViewDataSource {
